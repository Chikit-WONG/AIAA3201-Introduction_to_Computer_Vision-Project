...
def infer_fps(part1_root: Path, sequence_name: str, default_fps: float = 30.0) -> float:
    wild_candidate = part1_root.parent / 'data' / 'Wild_Video' / 'input_with_person' / f'{sequence_name}.mp4'
