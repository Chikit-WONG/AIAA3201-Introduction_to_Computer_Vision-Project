...
def main() -> None:
    ...
    variants = {
        "sam3": os.path.join(part3_root, "outputs", "ablation", "sam3", "metrics"),
        "sam3.1": os.path.join(part3_root, "outputs", "ablation", "sam3_1", "metrics"),
    }
    ...
    output_dir = os.path.join(part3_root, "outputs", "ablation", "summary")
